...
class RemoveItemFromCartUseCaseTest {
    ...
    void execute_RemoveItem_Success() {
        ...
        cart.addItem(productId1, 2, ProductOptions.of(Map.of("size", "L")));
    ...
    void execute_RemoveSpecificItem_Success() {
        ...
        cart.addItem(productId1, 1, ProductOptions.empty());
        cart.addItem(productId2, 2, ProductOptions.of(Map.of("color", "red")));
        cart.addItem(productId3, 3, ProductOptions.empty());
