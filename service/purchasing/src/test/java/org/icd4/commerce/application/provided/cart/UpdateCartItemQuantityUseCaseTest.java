...
class UpdateCartItemQuantityUseCaseTest {
    ...
    void execute_IncreaseQuantity_Success() {
        ...
        cart.addItem(productId, sku1,3, ProductOptions.empty());
    ...
    void execute_DecreaseQuantity_Success() {
        ...
        ProductId productId = ProductId.of("PROD-001");
        StockKeepingUnit sku1 = StockKeepingUnit.of("SKU-001");
        cart.addItem(productId, sku1, 5, ProductOptions.of(Map.of("size", "L")));
    ...
    void execute_MinimumQuantity_Success() {
        ...
        ProductId productId = ProductId.of("PROD-001");
        StockKeepingUnit sku1 = StockKeepingUnit.of("SKU-001");
        cart.addItem(productId, sku1, 10, ProductOptions.empty());
    ...
    void execute_MaximumQuantity_Success() {
        ...
        ProductId productId = ProductId.of("PROD-001");
        StockKeepingUnit sku1 = StockKeepingUnit.of("SKU-001");
        cart.addItem(productId, sku1, 50, ProductOptions.empty());
    ...
    void execute_UpdateSpecificItemQuantity() {
        ...
        cart.addItem(productId2, sku2, 3, ProductOptions.of(Map.of("color", "red")));
        cart.addItem(productId3, sku3, 4, ProductOptions.empty());
