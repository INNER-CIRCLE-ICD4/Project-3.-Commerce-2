...
class CartItemTest {
    ...
    void setUp() {
        ...
        options = ProductOptions.of(Map.of("size", "L", "color", "Red"));
    ...
    void createCartItem() {
        // when
        CartItem cartItem = new CartItem(cartItemId, productId, sku, options, 5, timeProvider);
        
        // then
        assertThat(cartItem.getId()).isEqualTo(cartItemId);
        assertThat(cartItem.getProductId()).isEqualTo(productId);
        assertThat(cartItem.getSku()).isEqualTo(sku);
    ...
    void throwExceptionWhenQuantityOutOfRange(int quantity) {
        // when & then
        assertThatThrownBy(() -> new CartItem(cartItemId, productId, sku, options, quantity, timeProvider))
    ...
    void throwExceptionWhenIncreaseQuantityExceedsMax() {
        // given
        CartItem cartItem = new CartItem(cartItemId, productId, sku, options, 95, timeProvider);
    ...
    void equalsAndHashCode() {
        // given
        CartItem cartItem1 = new CartItem(cartItemId, productId, sku, options, 5, timeProvider);
        CartItem cartItem2 = new CartItem(cartItemId, ProductId.of("TEST-001"), sku, ProductOptions.empty(), 10,
                timeProvider);
        CartItem cartItem3 = new CartItem(CartItemId.generate(), productId, sku, options, 5, timeProvider);
