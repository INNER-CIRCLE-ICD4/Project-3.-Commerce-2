...
class MergeCartsUseCaseTest {
    ...
    void execute_MergeAndDeleteSource_Success() {
        ...
        targetCart.addItem(productId1, sku1, 1, ProductOptions.empty());
        sourceCart.addItem(productId2, sku2, 3, ProductOptions.of(Map.of("size", "L")));
    ...
    void execute_MergeAndClearSource_Success() {
        ...
        targetCart.addItem(productId1, sku1, 2, ProductOptions.empty());
        sourceCart.addItem(productId2, sku2, 3, ProductOptions.of(Map.of("size", "L")));
    ...
    void execute_MergeSameProduct_SumQuantity() {
        ...
        targetCart.addItem(productId, sku1, 2, options);
        sourceCart.addItem(productId, sku2, 3, options);
    ...
    void execute_TargetCartAlreadyConverted() {
        // given
        targetCart.addItem(ProductId.of("PROD-001"), StockKeepingUnit.of("SKU-001"), 1, ProductOptions.empty());
        targetCart.convertToOrder();
        sourceCart.addItem(ProductId.of("PROD-002"), StockKeepingUnit.of("SKU-002"),1, ProductOptions.empty());
    ...
    void execute_ExceedItemLimitAfterMerge() {
        ...
        for (int i = 1; i <= 30; i++) {
            targetCart.addItem(
                    ...
                    StockKeepingUnit.of("SKU-TARGET-" + String.format("%03d", i)),
                    1,
        ...
        for (int i = 1; i <= 25; i++) {
            sourceCart.addItem(
                    ...
                    StockKeepingUnit.of("SKU-SOURCE-" + String.format("%03d", i)),
                    1,
                    ProductOptions.empty()
            );
        }
    ...
    void execute_EmptySourceCart_Success() {
        // given
        targetCart.addItem(ProductId.of("PROD-001"), StockKeepingUnit.of("SKU-001"), 2, ProductOptions.empty());
        // sourceCart는 비어있음
